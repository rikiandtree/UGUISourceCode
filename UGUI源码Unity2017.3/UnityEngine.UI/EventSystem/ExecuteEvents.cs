...
namespace UnityEngine.EventSystems
{
    public static class ExecuteEvents
    {
        ...
        /// <summary>
        /// 转换成IPointerClickHandler执行OnPointerClick函数
        /// </summary>
        /// <param name="handler">点击事件的接口</param>
        ...
        /// <summary>
        /// 事件处理的最主要的函数：收集target上的T组件，然后传入functor委托执行
        /// </summary>
        /// <typeparam name="T">事件类型</typeparam>
        /// <param name="target">需要处理事件对象</param>
        /// <param name="eventData">事件数据</param>
        /// <param name="functor">事件执行函数</param>
        /// <returns></returns>
        ...
        /// 获得物体上挂载的IEventSystemHandler的组件添加进results
        /// </summary>
