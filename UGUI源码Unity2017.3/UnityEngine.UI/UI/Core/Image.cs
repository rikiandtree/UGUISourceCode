...
namespace UnityEngine.UI
{
    ...
    public class Image : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        private void GenerateSlicedSprite(VertexHelper toFill)
        {
            ...
            //rect是recttransform相对于canvas的精确坐标以及像素
        ...
        /// <summary>
        /// 根据对角线顶点坐标以及对角线顶点的UV坐标构造三角形组成的矩形
        /// </summary>
        /// <param name="vertexHelper">顶点构造器</param>
        /// <param name="posMin">对角线最小坐标</param>
        /// <param name="posMax">对角线最大坐标</param>
        /// <param name="color">颜色</param>
        /// <param name="uvMin">最小UV坐标</param>
        /// <param name="uvMax">最大UV坐标</param>
        ...
        /// 计算适配后的边框
        /// </summary>
        /// <param name="border">需要计算的边框</param>
        /// <param name="adjustedRect">需要适配的rect</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// 按覆盖方式以及覆盖范围计算顶点数据以及三角形
        /// </summary>
        /// <param name="toFill">顶点构造器</param>
        /// <param name="preserveAspect">是否按原图比例</param>
